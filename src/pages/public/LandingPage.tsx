...
export const LandingPage: React.FC = () => {
  return (
    <section className="relative isolate flex min-h-screen flex-col overflow-hidden bg-[hsl(var(--background))] text-[hsl(var(--foreground))]">
      ...
      <nav className="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-8 py-6" aria-label="Primary navigation">
        <Link
          to="/"
        ...
        <div className="hidden items-center gap-7 md:flex">
          <Link to="/" className="text-sm text-[hsl(var(--foreground))] transition-colors">
            Home
          </Link>
          <Link to="/marketplace" className="text-sm text-[hsl(var(--muted-foreground))] transition-colors hover:text-[hsl(var(--foreground))]">
            Marketplace
          </Link>
          <Link to="/how-it-works" className="text-sm text-[hsl(var(--muted-foreground))] transition-colors hover:text-[hsl(var(--foreground))]">
            How It Works
          </Link>
          <Link to="/security" className="text-sm text-[hsl(var(--muted-foreground))] transition-colors hover:text-[hsl(var(--foreground))]">
            Security
          </Link>
          <a href="mailto:support@keystone.demo" className="text-sm text-[hsl(var(--muted-foreground))] transition-colors hover:text-[hsl(var(--foreground))]">
            Reach Us
          </a>
        </div>
